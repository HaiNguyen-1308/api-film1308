        ...
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red sbold uppercase">Chỉnh sửa ebook</span>
                </div>
            </div>
            <div class="portlet-body">
                <!-- BEGIN FORM-->
                <form action="{{route('adpostEditEbook', ['id' => $data->id])}}" method="POST" class="form-horizontal" enctype='multipart/form-data'>
                    {{ csrf_field() }}
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label col-md-3">Tên ebook
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                src="{{asset('public/admins/img/ebooks/' .$data->cover)}}" @else class="hidden" @endif >
                            </div>
                        </div>
